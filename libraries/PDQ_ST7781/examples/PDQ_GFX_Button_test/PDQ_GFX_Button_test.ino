...
PDQ_ILI9341 tft = PDQ_ILI9341();		// PDQ_GFX lcd library object
...
void setup(void)
{
	...
	button[0].initButton(&tft, 60, 100, 72, 72, ILI9341_RED, ILI9341_BLACK, ILI9341_WHITE, "Decrement", 1);
	button[1].initButton(&tft, 180, 100, 72, 72, ILI9341_GREEN, ILI9341_BLACK, ILI9341_WHITE, "Increment", 1);
