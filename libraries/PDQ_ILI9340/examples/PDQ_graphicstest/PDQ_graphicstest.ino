...
// AF: #include <Adafruit_ILI9340.h>		// AF: Hardware-specific library
// AF: Adafruit_ILI9340 tft(10,  9, 8); 	// AF: create LCD object (HW SPI, CS=pin 10, D/C=pin 8, reset=9)
...
void setup()
{
	...
	Serial.println(F("PDQ ILI9340 2.2\" SPI TFT Test!     ")); 
#else
 	Serial.println(F("Adafruit ILI9340 2.2\" SPI TFT Test!")); 
#endif
...
#if defined(_PDQ_ILI9340H_)
	tft.print(F("PDQ GFX+PDQ ILI9340 "));
#else
 	tft.print(F("Adafruit GFX+ILI9340"));
#endif
	tft.setTextSize(1);
