...
PDQ_ILI9340 tft = PDQ_ILI9340();		// PDQ_GFX lcd library object
...
void setup(void)
{
	...
	button[0].initButton(&tft, 60, 100, 72, 72, ILI9340_RED, ILI9340_BLACK, ILI9340_WHITE, "Decrement", 1);
	button[1].initButton(&tft, 180, 100, 72, 72, ILI9340_GREEN, ILI9340_BLACK, ILI9340_WHITE, "Increment", 1);
