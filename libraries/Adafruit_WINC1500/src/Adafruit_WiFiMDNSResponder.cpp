...
Adafruit_WiFiMDNSResponder::Adafruit_WiFiMDNSResponder() :
...
bool Adafruit_WiFiMDNSResponder::begin(const char* _name, uint32_t _ttlSeconds)
{
...
void Adafruit_WiFiMDNSResponder::poll()
{
  if (parseRequest()) {
    replyToRequest();
  }
...
bool Adafruit_WiFiMDNSResponder::parseRequest()
{
...
void Adafruit_WiFiMDNSResponder::replyToRequest()
{
